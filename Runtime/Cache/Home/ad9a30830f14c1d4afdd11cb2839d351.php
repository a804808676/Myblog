		...
		<div class="row aerousel">
			...
			<?php if(is_array($articles)): $i = 0; $__LIST__ = $articles;if( count($__LIST__)==0 ) : echo "暂时没有文章" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><article>
				<h5>
					...
					<?php if(($v["a_view"]) == "2"): ?><img  class="title_r hidden-xs" src="/anxun/blog/Public/Img/icon/tuijian.gif"/><?php endif; ?>
				</h5>
				<div class="clearfix" >           
					<p class="article-remark"> 
						<a class="article-img-a image-light hidden-xs" href="<?php echo U('/article-'.$v['a_id']);?>">
							<img src="<?php echo ($v["a_img"]); ?>" class="article-img" alt="<?php echo ($v["a_title"]); ?>" title="<?php echo ($v["a_title"]); ?>" />
						</a>
						<?php echo ($v["a_remark"]); ?>
...
<script src="/anxun/blog/Public/Js/jquery.fancybox.js"></script>	
	<script src="/anxun/blog/Public/Js/jquery.nivo.slider.pack.js"></script>
