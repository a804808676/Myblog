...
<link rel="stylesheet" href="/anxun/blog/Public/Css/my.css" />
	...
	<div class="col-md-8 row-l gust">
		...
		<h4>请文明留言</h4><hr />
		<?php if(is_array($contents)): $i = 0; $__LIST__ = $contents;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="media connect">
			...
			<div class="fool hidden-xs">#<?php echo ($v["g_id"]); ?></div>
				<p class="media-heading"><a><span class="glyphicon glyphicon-user"></span></a>&nbsp;&nbsp;&nbsp;<?php echo ($v["g_name"]); ?>&nbsp;&nbsp;&nbsp;<a><span class="glyphicon glyphicon-time"></span></a>&nbsp;<?php echo (getTime($v["g_time"])); ?>&nbsp;&nbsp;&nbsp;&nbsp;<a class="from"><?php echo ($v["g_from"]); ?></a>&nbsp;&nbsp;&nbsp;&nbsp;<a><span class="glyphicon glyphicon-map-marker"></span></a>&nbsp;&nbsp;<?php echo ($v["ip"]); ?></p>
		...
		<div class="home-from">
			...
			<div class="well">
            <div method="post" >
			<input id="jump" type="hidden"  value="/anxun/blog/gust.html" />
