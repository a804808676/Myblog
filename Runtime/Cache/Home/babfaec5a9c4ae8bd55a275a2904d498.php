...
<link rel="stylesheet" href="/anxun/blog/Public/Css/my.css" />
    ...
    <div class="row aerousel">
		...
		<ul class="album-div">
        <?php if(is_array($albumList)): $i = 0; $__LIST__ = $albumList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li class="album-li">
                <div class="image-light album-img">
                  	<img src="<?php echo ($v["al_img"]); ?>" alt="<?php echo ($v["al_name"]); ?>">
                </div>
                <div class="caption album-remark">
                    <h5><?php echo ($v["al_name"]); ?></h5>
                    <a href="<?php echo U("/album-".$v['al_id']);?>" class="btn btn-primary btn-xs" role="button">查看全部</a>
                </div>
