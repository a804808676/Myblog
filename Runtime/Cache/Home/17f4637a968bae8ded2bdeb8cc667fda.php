...
<head>
	<meta charset="utf-8">
	<title>说说 - <?php echo (C("NAME")); ?></title>
...
<link rel="stylesheet" href="/anxun/blog/Public/Css/my.css" />
	...
	<div class="row aerousel">
		<ol class="breadcrumb">
			...
			<li class="active">闲言碎语</li>
		</ol>
		<div class="col-md-8 row-l">
			<?php if(is_array($say)): $i = 0; $__LIST__ = $say;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="media feel">
					<div class="f-time"><a><span class="glyphicon glyphicon-dashboard"></span></a>&nbsp;&nbsp;<?php echo (getTime($v["s_time"])); ?> 在 <a class="from"><?php echo ($v["s_from"]); ?></a> 说到：</div>
					<div class="media-left media-middle">
					    <img class="media-object img-50" src="<?php echo ($system["admin_img"]); ?>" alt="...">
					</div>
					<div class="media-body feel-body"><a href="<?php echo U('/feel-'.$v['s_id']);?>"><?php echo ($v["s_content"]); ?></a></div>
