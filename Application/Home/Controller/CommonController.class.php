...
//		foreach ($s_article as $key => $value) {
//		    $imgpath = __ROOT__.$value["a_img"];
//            $s_article[$key]["a_img"] = $imgpath;
//        }
...
//        foreach ($s_content as $key => $value) {
//            switch ($value) {
//                case isset($value["alc_img"]);
//                    $imgpath = __ROOT__.$value["alc_img"];
//                    $s_content[$key]["alc_img"] = $imgpath;
//                 break;
//                case isset($value["sc_img"]);
//                    $imgpath = __ROOT__.$value["sc_img"];
//                    $s_content[$key]["sc_img"] = $imgpath;
//                 break;
//                case isset($value["ac_img"]);
//                    $imgpath = __ROOT__.$value["ac_img"];
//                    $s_content[$key]["ac_img"] = $imgpath;
//                 break;
//            }
//        }
