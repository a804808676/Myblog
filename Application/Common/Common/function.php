...
function makeImg($str)
{
    ...
    $url = __ROOT__.'/Upload/Thumb/' . $time . '.jpg';
    return $url;
}
...
function getImg($str)
{
    ...
    $url = __ROOT__.'/Upload/Album/' . $time . '.jpg';
    return $url;
}
...
function getAThumb($str, $width = 600, $height = 300)
{
    ...
    $url = __ROOT__.'/Upload/Thumb/' . $name . '.jpg';
    return $url;
}
...
function check_img($email)
{
    ...
    if ($img == '') {
        $tmp = __ROOT__.'/Public/Img/Portrait/' . mt_rand(1, 100) . '.jpg';
    } else {
        $tmp = $img;
    }
    return $tmp;
